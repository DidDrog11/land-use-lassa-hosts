...
save_plot(plot = grids_plot[[1]] +
            labs(title = "A)") +
            guides(fill = "none"), filename = here("output", "figures", "Supplementary_Figure_1a.png"), base_height = 3, base_width = 7)
save_plot(plot = grids_plot[[2]] +
            labs(title = "B)") +
            guides(fill = "none"), filename = here("output", "figures", "Supplementary_Figure_1b.png"), base_height = 4, base_width = 6)
save_plot(plot = grids_plot[[3]] +
            labs(title = "C)") +
            guides(fill = "none"), filename = here("output", "figures", "Supplementary_Figure_1c.png"), base_height = 3, base_width = 7)
save_plot(plot = grids_plot[[4]] +
            labs(title = "D)") +
            guides(fill = "none"), filename = here("output", "figures", "Supplementary_Figure_1d.png"), base_height = 3, base_width = 7)
